...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink, { as: "a", href: href, "aria-label": "Knights DeFi home page" },
            ...
            React__default['default'].createElement("img", { src: "https://ipfs.io/ipfs/QmPyhbCeCyRLKuEkkLKkjAT8zhK2DPaKHJ35sNH3UdzM9V?filename=banner.svg", alt: "Knights DeFi Logo", className: "desktop-icon" }))) : (React__default['default'].createElement(StyledLink, { to: href, "aria-label": "Knights DeFi home page" },
            React__default['default'].createElement("img", { src: "https://ipfs.io/ipfs/QmPDPkJHr65KxEDWEE725CuvK5ytfWXbx1fpAKiWf8PNoR?filename=logo.svg", alt: "Knights DeFi Logo", className: "mobile-icon" }),
            React__default['default'].createElement("img", { src: "https://ipfs.io/ipfs/QmPyhbCeCyRLKuEkkLKkjAT8zhK2DPaKHJ35sNH3UdzM9V?filename=banner.svg", alt: "Knights DeFi Logo", className: "desktop-icon" })))));
};
var templateObject_1$c;
...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav, toggleTheme = _a.toggleTheme, isDark = _a.isDark, cakePriceUsd = _a.cakePriceUsd, tablePriceUsd = _a.tablePriceUsd, legendPriceUsd = _a.legendPriceUsd, squirePriceUsd = _a.squirePriceUsd; _a.currentLang; _a.langs; _a.setLang;
    if (!isPushed) {
